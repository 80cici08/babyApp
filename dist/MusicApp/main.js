...
var RecordService = /** @class */ (function () {
    function RecordService(_http) {
        this._http = _http;
        // the URLs to call the http services API
        this._createRecordUrl = '/api/record/';
        this._findAllRecordsForUserUrl = '/api/record/';
        this._findRecordByIdUrl = '/api/record/';
        this._updateRecordUrl = '/api/record/';
        this._deleteRecordUrl = '/api/record/';
    }
    // the http CRUD services
    RecordService.prototype.createRecord = function (userId, record) {
        var new_record = {
            type: record.type,
            url: record.url,
            name: record.name,
        ...
        return this._http.post(this._createRecordUrl + userId + '/record', new_record);
    };
    RecordService.prototype.findRecordsByUser = function (userId) {
        return this._http.get(this._findAllRecordsForUserUrl + userId + '/record');
    };
    RecordService.prototype.findRecordById = function (recordId) {
        return this._http.get(this._findRecordByIdUrl + recordId);
    };
    RecordService.prototype.updateRecord = function (recordId, record) {
        return this._http.put(this._updateRecordUrl + recordId, record);
    };
    RecordService.prototype.deleteRecord = function (recordId) {
        return this._http.delete(this._deleteRecordUrl + recordId);
    };
...
var RecordEditComponent = /** @class */ (function () {
    function RecordEditComponent(mapsAPILoader, ngZone, sharedService, activatedRoute, router, recordService) {
    ...
    RecordEditComponent.prototype.onEditRecord = function () {
        ...
        this.recordService.updateRecord(this.recordId, this.record)
            .subscribe(function (data) {
            _this.router.navigate(['/record']);
        }, function (error) {
            console.log(error);
        });
    };
    RecordEditComponent.prototype.onDeleteRecord = function () {
        var _this = this;
    ...
    RecordEditComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_agm_core__WEBPACK_IMPORTED_MODULE_3__["MapsAPILoader"],
            ...
            _services_record_service__WEBPACK_IMPORTED_MODULE_7__["RecordService"]])
    ], RecordEditComponent);
...
/* harmony import */ var _services_record_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../services/record.service */ "./src/app/services/record.service.ts");
/* harmony import */ var _services_shared_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../../services/shared.service */ "./src/app/services/shared.service.ts");
...
var RecordListComponent = /** @class */ (function () {
    function RecordListComponent(router, sanitizer, recordService, sharedService) {
        this.router = router;
    ...
    RecordListComponent.prototype.onAddRecord = function () {
        var _this = this;
        ...
        this.recordService.createRecord(this.sharedService.user._id, new_record)
            .subscribe(function (data) {
            _this.router.navigate(['/record', data._id]);
        }, function (error) {
            console.log(error);
        });
    };
    RecordListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
            ...
            _services_record_service__WEBPACK_IMPORTED_MODULE_4__["RecordService"],
            _services_shared_service__WEBPACK_IMPORTED_MODULE_5__["SharedService"]])
    ], RecordListComponent);
...
module.exports = __webpack_require__(/*! /Users/xuejiangyang/Documents/NEU/CS5610/Project/BabyApp/src/main.ts */"./src/main.ts");
